...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Location = System::Drawing::Point(238, 154);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(239, 219);
			...
			this->button2->Location = System::Drawing::Point(449, 24);
			...
			this->button1->Location = System::Drawing::Point(605, 24);
			...
			this->button3->Location = System::Drawing::Point(221, 448);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(287, 23);
			this->button3->TabIndex = 8;
			this->button3->Text = L"Place order ";
			this->button3->UseVisualStyleBackColor = false;
			this->button3->Click += gcnew System::EventHandler(this, &cash::button3_Click);
			// 
			// cash
			// 
